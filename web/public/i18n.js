(() => {
  ...
  const dict = {
    zh: {
      ...
      enter: "进入",
      loginTitle: "登录 · GGOK",
      loginHint: "用 ggok start 打印的 token 登录",
      sessionBusy: "会话被终端占用",
      ...
      questionChat: "先聊聊",
      questionOther: "其他",
      questionOtherPh: "输入你的回答",
      questionMulti: "可多选",
      questionNeedAnswers: "请先回答所有问题",
      ...
      builtinSkills: "内置",
      quickSkills: "内置",
      quickEmpty: "没有匹配的内置技能",
      skillKindSlash: "斜杠",
      skillKindAuto: "自动",
      skillKindGuide: "参考",
      skillInsertCmd: "插入命令",
      skillUseInChat: "在对话中使用",
      skillWritePrompt: "写进对话",
      skillChipPh: "直接说要做什么",
      skillGuidePrompt: "按「{name}」技能帮我处理：",
      mcpFromPlugin: "来自插件 {name}",
      mcpManual: "手动添加",
      mcpFromPlugins: "插件提供",
      pluginProvidesMcp: "提供连接器 {name}",
      viewConnector: "查看连接器",
      viewPlugin: "查看插件",
      extAllBuiltin: "所有内置技能",
      ...
      slashRpcSoon: "即将在 Web 提供，不会当作聊天发出去",
      rewindTitle: "回退到某一轮",
      rewindNote: "之后的对话会丢掉，工作区文件不还原。",
      rewindConfirm: "回退会丢掉这轮之后的对话，且不会还原工作区文件。继续？",
      rewindDone: "已回退",
      rewindEmpty: "没有可回退的轮次",
      rewindNeedSession: "先打开一个会话",
      rewindMissing: "找不到这一轮",
      rewindHere: "回退到这里",
      retryHere: "从这里重问",
      retryConfirm: "发送将丢掉这条之后的对话。继续？",
      retryEditHint: "发送将丢掉这条之后的对话",
      modeAsk: "Ask",
      modePlan: "Plan",
      modeAuto: "Auto",
      modeAlways: "Always",
      modeAskDesc: "动手前先问你",
      modePlanDesc: "先写计划，批准再执行",
      modeAutoDesc: "安全操作自动批，危险的仍会问",
      modeAlwaysDesc: "几乎不再询问权限",
      modeTip: "选择会话模式",
      todosTitle: "待办",
      todosProgress: "待办 {done}/{total}",
      planTitle: "计划",
      planEmpty: "还没有 plan.md",
      planApprove: "批准",
      planRevise: "要改",
      planExit: "退出计划",
      planReviseHint: "在输入框写修改说明后发送",
      imageN: "图 {n}",
      jumpBottom: "回到底部",
      turnMapAria: "跳到这条",
      turnMapImage: "图片",
      ...
      workflowsTab: "工作流",
      agentsTab: "Agents",
      hooksEmpty: "没有 hooks，或需要在配置里修改",
      workflowsEmpty: "没有工作流",
      agentsEmpty: "没有 Agent 定义",
    },
    en: {
      newSession: "New Chat",
      themeLight: "Light",
      ...
      allow: "Allow",
      deny: "Deny",
      questionTitle: "Choose an option",
      questionSubmit: "Submit",
      questionSkip: "Skip",
      questionChat: "Talk first",
      questionOther: "Other",
      questionOtherPh: "Type your answer",
      questionMulti: "Select all that apply",
      questionNeedAnswers: "Answer every question first",
      ...
      noTokenBreakdown: "No token breakdown yet.",
      ...
      quickSkills: "Built-in",
      quickEmpty: "No matching built-in skills",
      skillKindSlash: "Slash",
      skillKindAuto: "Auto",
      skillKindGuide: "Guide",
      skillInsertCmd: "Insert command",
      skillUseInChat: "Use in chat",
      skillWritePrompt: "Write into chat",
      skillChipPh: "Describe what you want to do",
      skillGuidePrompt: "Follow the {name} skill to help me: ",
      mcpFromPlugin: "From plugin {name}",
      mcpManual: "Added manually",
      mcpFromPlugins: "From plugins",
      pluginProvidesMcp: "Provides connector {name}",
      viewConnector: "View connector",
      viewPlugin: "View plugin",
      extAllBuiltin: "All built-in skills",
      ...
      session: "Session",
      slashRpcSoon: "Coming to Web soon. This is not sent as a chat message.",
      rewindTitle: "Rewind to a turn",
      rewindNote: "Later conversation is discarded. Workspace files are not restored.",
      rewindConfirm: "Rewind discards later turns and does not restore workspace files. Continue?",
      rewindDone: "Rewound",
      rewindEmpty: "No rewind points",
      rewindNeedSession: "Open a session first",
      rewindMissing: "That turn was not found",
      rewindHere: "Rewind here",
      retryHere: "Retry from here",
      retryConfirm: "Sending will discard later turns. Continue?",
      retryEditHint: "Sending will discard later turns",
      modeAsk: "Ask",
      modePlan: "Plan",
      modeAuto: "Auto",
      modeAlways: "Always",
      modeAskDesc: "Ask before acting",
      modePlanDesc: "Write a plan, then approve",
      modeAutoDesc: "Auto-approve safe tools; ask on risky ones",
      modeAlwaysDesc: "Almost never ask for permission",
      modeTip: "Choose session mode",
      todosTitle: "Todos",
      todosProgress: "Todos {done}/{total}",
      planTitle: "Plan",
      planEmpty: "No plan.md yet",
      planApprove: "Approve",
      planRevise: "Revise",
      planExit: "Exit plan",
      planReviseHint: "Describe the change in the composer, then send",
      imageN: "Image {n}",
      jumpBottom: "Back to bottom",
      turnMapAria: "Jump to this message",
      turnMapImage: "Image",
      turnMapFile: "Attachment",
      draftGone: "Some attachments are gone",
      btwNeedText: "Usage: /btw aside text",
      compacting: "Compacting…",
      peekTitle: "Subagent",
      peekEmpty: "No content",
      peekFailed: "Could not open subagent",
      subagentRunning: "Running",
      subagentCompleted: "Completed",
      subagentCancelled: "Cancelled",
      subagentFailed: "Failed",
      permRejectMessage: "Optional note when rejecting",
      tasksTitle: "Tasks",
      ...
      agentsTab: "Agents",
      hooksEmpty: "No hooks listed. Edit config to add them.",
      workflowsEmpty: "No workflows",
      agentsEmpty: "No agent definitions",
    }
  };
